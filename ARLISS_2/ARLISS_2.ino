...
void distance(){
  ...
  y = (40.533686 - Lat)*111111.49; //GLatに目標地点の緯度を代入//グラウンド43.824388,143.902931//倉庫43.824226,143.904061
  x = (-119.063390 - Lng)*cos(Lat*PI*180)*111111.49;                                //GLngに目標地点の経度を代入
...
//上昇検知
  while (count < 3) {
    ...
    DPS310();
    H1 = H;
    Serial1.print("TXDA 上昇検知中"+String(H)+"\r\n");
    delay(3000);    
    if (H1 > 500) {
...
break;      
    ...
    //Serial1.print("TXDA 下降検知中"+String(H)+"\r\n");
    DPS310();
    H1 = H;
    // delay(3000);
    Serial1.print("TXDA 下降検知中"+String(H)+"\r\n");
